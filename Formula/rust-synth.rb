class RustSynth < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/fortunto2/rust-synth/releases/download/v0.16.0/rust-synth-v0.16.0-aarch64-apple-darwin.tar.gz"
      sha256 "db5a5b34ded5ebf9936f7aba934e2cf96432f0af523162a8434db49adcfc5466"
    end
  end
  ...
  test do
    # Offline render — no audio device needed, deterministic.
